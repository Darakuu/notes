...
# Autovalutazione 1 – Acustica 1

1. **Suono e Audio sono sinonimi.** Utilizziamo il termine "Suono" nel contesto di onde meccaniche, mentre quello "Audio" nel contesto di onde elettromagnetiche. 
   - [ ] Vero  
   - [ ] Falso

2. **Il suono è un insieme di onde meccaniche longitudinali, generato da una sorgente in vibrazione che propaga l'energia in un mezzo o nel vuoto modificando la pressione locale delle particelle che costituiscono il mezzo, o attraverso onde elettromagnetiche se nel vuoto.**
   - [ ] Vero  
   - [ ] Falso

3. **L'Audio è un segnale elettromagnetico che si può trasmettere nel vuoto.**
   - [ ] Vero  
   - [ ] Falso

4. **Quale delle due affermazioni è vera?**
   - [ ] Il suono permette la trasmissione dell'audio  
   - [ ] L'audio permette la trasmissione del suono

5. **Quale delle due affermazioni è vera? Nella storia degli strumenti di registrazione e riproduzione musicale si è imparato...**
...
7. **La definizione di "onda meccanica" è relativa a...**
...
8. **La definizione di "onda trasversale" è relativa a...**
   - [ ] Mezzo di propagazione  
   - [ ] Forma d'onda  
   - [ ] Direzione di spostamento dell'energia  
   - [ ] Direzione di oscillazione delle particelle  
...
9. **La definizione di "onda sinusoidale" è relativa a...**
   - [ ] Mezzo di propagazione  
   - [ ] Forma d'onda  
   - [ ] Direzione di spostamento dell'energia  
   - [ ] Direzione di oscillazione delle particelle  
...
10. **La definizione di "onda che si ripete ogni T secondi" è relativa a...**
    - [ ] Mezzo di propagazione  
    - [ ] Forma d'onda  
    - [ ] Direzione di spostamento dell'energia  
    - [ ] Direzione di oscillazione delle particelle  
...
11. **Quali sono i 3 elementi necessari per il verificarsi della sensazione sonora?**
    - [ ] Strumento musicale  
    - [ ] Mezzo di propagazione  
    - [ ] Silenzio  
...
12. **L'ampiezza di un'onda è associata a...**
    - [ ] Volume del suono  
...
13. **La fase di un'onda è associata a...**
    - [ ] Volume del suono  
    - [ ] Energia trasportata dall'onda  
    - [ ] Intensità del suono  
    - [ ] Altezza del suono  
...
14. **La frequenza di un'onda è associata a...**
    - [ ] Volume del suono  
    - [ ] Energia trasportata dall'onda  
    - [ ] Intensità del suono  
    - [ ] Altezza del suono  
...
16. **L'unità di misura della lunghezza d'onda è...**
    - [ ] m  
    - [ ] mm  
    - [ ] nm  
    - [ ] W

17. **Data l'equazione sinusoidale y(t) = 3 sin (12*π*t + 4), l'ampiezza vale...**
    - [ ] 3  
    - [ ] 12  
    - [ ] 6  
    - [ ] 4

18. **Data l'equazione sinusoidale y(t) = 3 sin (12*π*t + 4), la frequenza vale...**
    - [ ] 3  
    - [ ] 12  
    - [ ] 6  
    - [ ] 4

19. **Data l'equazione sinusoidale y(t) = 3 sin (12*π*t + 4), la fase vale...**
    - [ ] 3  
    - [ ] 12  
    - [ ] 6  
    - [ ] 4
...
# Autovalutazione 2 – Acustica 2

1. **La pressione si misura in...**
   - [ ] Pascal  
   - [ ] N / m^2  
   - [ ] N / m  
   - [ ] N^2 / m  
...
2. **L'intensità sonora si misura in...**
   - [ ] Pascal  
   - [ ] N / m^2  
   - [ ] N / m  
   - [ ] N^2 / m  
...
3. **Calcolare l'RMS dei seguenti valori: 0, 1, 0, -1**
   - [ ] √2 / 2  
   - [ ] 1 / √2  
   - [ ] √(1/2)  
   - [ ] √(2/4)
...
4. **Calcolare l'RMS dei seguenti valori: 0, 2, 0, -2**
   - [ ] √2  
   - [ ] 1 / √2  
   - [ ] √(8/4)  
   - [ ] √(4/8)
...
5. **Qual è la soglia MIN di udibilità (in Pa)?**
   - [ ] 2.5 x 10e-5 Pa  
   - [ ] 25 microPa  
   - [ ] 2.5 microPa  
   - [ ] 25 x 10e-5 Pa  
...
6. **Qual è la soglia MAX di udibilità (in Pa)?**
   - [ ] 3 Pa  
   - [ ] 30 Pa  
   - [ ] 300 Pa  
   - [ ] 3000 Pa  
...
7. **La scala logaritmica tende a...**
   - [ ] Aumentare il range di valori, per una maggiore precisione  
   - [ ] Appiattire gli incrementi per valori elevati

8. **1 Decibel corrisponde a...**
   - [ ] 10 volte un Bel  
   - [ ] Un decimo di Bel

9. **Il Decibel è una "unità di misura relativa" perché...**
   - [ ] È relativa all'unità di misura utilizzata  
   - [ ] È relativa alla pressione atmosferica di 1M Pa  
   - [ ] Serve a misurare il rapporto di due grandezze omogenee

10. **Data una sorgente in grado di emettere con potenza 200.000 W, calcolare i dB assoluti rispetto ad una sorgente di riferimento di 20.000 W**
    - [ ] 0 dB  
    - [ ] 1 dB  
    - [ ] 10 dB  
    - [ ] 100 dB

11. **Data una sorgente in grado di emettere con potenza 300.000 W, calcolare i dB assoluti rispetto ad una sorgente di riferimento di 3.000 W**
    - [ ] 1 dB  
    - [ ] 2 dB  
    - [ ] 3 dB  
    - [ ] 10 dB  
...
12. **Data una sorgente in grado di emettere con potenza 300 W, calcolare i dB assoluti rispetto ad una sorgente di riferimento di 3.000 W**
    - [ ] -20 dB  
    - [ ] -10 dB  
    - [ ] -1 dB  
    - [ ] 0 dB  
...
13. **La soglia del dolore nella scala dB SPL è fissata a...**
    - [ ] 100 dB  
    - [ ] 110 dB  
    - [ ] 120 dB  
    - [ ] 130 dB  
...
14. **In quale range dinamico andrebbe suonata la musica?**
    - [ ] 10 - 30 dB  
    - [ ] 0 - 40 dB  
    - [ ] 0 - 130 dB  
    - [ ] 30 - 50 dB  
...
# Autovalutazione 3 – Acustica 3

1. **La legge dell'inverso del quadrato afferma che...**
...
2. **Un suono viene percepito con intensità 100 W/m^2 a distanza 1 metro. Quale sarà la sua intensità percepita a distanza 5 metri?**
   - [ ] 100 W/m^2
   - [ ] 25 W/m^2
   - [ ] 8 W/m^2
   - [ ] 4 W/m^2
   ...
   - [ ] 0.04 W/m^2
   - [ ] 0.4 W/m^2
   - [ ] È già troppo lontano per essere percepito

3. **Un suono viene percepito con intensità 100 W/m^2 a distanza 2 metri. Quale sarà la sua intensità percepita a distanza 4 metri?**
   - [ ] 100 W/m^2
   - [ ] 25 W/m^2
   - [ ] 8 W/m^2
   - [ ] 4 W/m^2
...
4. **Un suono viene percepito con intensità 100 W/m^2 a distanza 9 metri. Quale sarà la sua intensità percepita a distanza 3 metri?**
   - [ ] 1000 W/m^2
   - [ ] 900 W/m^2
   - [ ] 300 W/m^2
   - [ ] 90 W/m^2
...
5. **La velocità del suono nell'aria è...**
   - [ ] 343.85 m/s
   - [ ] 521.22 m/s
   - [ ] 12.94 m/s
   - [ ] 440 Hz
...
6. **A livello del mare, a che temperatura il suono viaggia nell'aria se ha una velocità di a 331.45 m/s?**
   - [ ] 20°C
   - [ ] 10°C
   - [ ] 0°C
   - [ ] -10°C
...
7. **Calcolare la velocità del suono nell'aria a 35°C (a 1 Atmosfera)**
   - [ ] 373.11 m/s
   - [ ] 363.24 m/s
   - [ ] 353.15 m/s
   - [ ] 343.85 m/s
...
8. **Calcolare la velocità del suono nell'aria a -20°C (a livello del mare)**
   - [ ] 363.24 m/s
   - [ ] 343.85 m/s
   - [ ] 331.45 m/s
   - [ ] 319.05 m/s
...
9. **Quale potrebbe essere un limite minimo di velocità per un suono che viaggia nell'aria (a 1Atm)?**
   - [ ] 0 m/s
   - [ ] 100 m/s
   - [ ] 110.20 m/s
   - [ ] 145 m/s
...
10. **A che velocità viaggia l'audio trasmesso come onda elettromagnetica nello spazio?**
    - [ ] 343.85 m/s
...
11. **Quali fattori possono influenzare la velocità del suono nell'acqua?**
...
12. **Cosa possiamo dire in merito alla velocità del suono nell'acqua?**
    ...
    - [ ] È sempre variabile sia in positivo che in negativo con l'aumentare della profondità
    - [ ] È più veloce in superficie
    - [ ] È più veloce a medie profondità (non molto in basso, ma neanche in superficie)
    - [ ] È più veloce ad altissime profondità (molto in basso)
    - [ ] È più veloce nel Mar Morto
    - [ ] È più veloce nel Lago di Garda

---
# Autovalutazione 4 – Acustica 4

1. **Se un'onda durante la propagazione subisce una deviazione che la "spezza" in più onde, allora si è verificata la...**
   - [ ] Rifrazione
   - [ ] Riflessione
   - [ ] Diffrazione
...
2. **Osservando la Figura 1, dove ci aspettiamo che sia maggiore la temperatura?**
   - [ ] In alto
   - [ ] Al centro
   - [ ] In basso
   - [ ] Ovunque
...
3. **Osservando la Figura 1, quale ci aspettiamo che sia il verso di propagazione finale delle onde sonore?**
   - [ ] In alto
   - [ ] Al centro
   - [ ] In basso
   - [ ] Non abbiamo abbastanza elementi per rispondere

4. **Osservando la Figura 1, supponendo che a destra ci sia un ascoltatore:**
...
5. **Affinche si verifichi la riflessione:**
   - [ ] La lunghezza d'onda dev'essere più grande dell'ostacolo, per garantire sufficiente energia per la riflessione
   - [ ] La lunghezza d'onda dev'essere più piccola dell'ostacolo, e si perderà energia dopo la riflessione
...
6. **Quanto tempo impiegherebbe un SONAR ad individuare nell'acqua di mare un oggetto distante 2 km? (si assuma v = 1500 m/s e pressione 1 Atm)**
   - [ ] Circa 4 secondi
   - [ ] Circa 3.5 secondi
   - [ ] Circa 3 secondi
   - [ ] Circa 2.5 secondi
...
7. **Sapendo che un dispositivo nell'aria a 1 Atm e 20°C (v = 343.85 m/s) emette un suono al tempo t e registra lo stesso suono tornare indietro dopo 10 secondi, calcolare la distanza dell'oggetto che ha riflesso il suono all'indietro.**
   - [ ] 3622.72 m
   - [ ] 3438.5 m
   - [ ] 2498.1 m
   - [ ] 1719.25 m
...
8. **\[Doppio calcolo] Sapendo che un SONAR impiega 3 secondi a rilevare un ostacolo a distanza 500 m nell'aria (a 1 Atm), a che temperatura è l'aria?**
   - [ ] 10°C
   - [ ] 5°C
   - [ ] 2.5°C
   - [ ] 0°C
...
9. **Qual è la distanza minima affinché si possa verificare l'eco (nell'aria a 20°C e 1 Atm)?**
   - [ ] 20 m
   - [ ] 19 m
   - [ ] 18 m
   - [ ] 17 m
...
10. **Qual è la distanza minima affinché si possa verificare l'eco (nell'acqua, assumendo v = 1500 m/s e 1 Atm)?**
    - [ ] 100 m
    - [ ] 75 m
    - [ ] 50 m
    - [ ] 25 m
...
11. **Qual è la velocità che dovrebbe avere un suono nell'aria a 1 Atm, affinché sia vero che l'eco si percepisca con distanza minima pari ad almeno 25 m?**
    - [ ] 1000 m/s
    - [ ] 750 m/s
    - [ ] 500 m/s
    - [ ] 250 m/s
...
12. **Effetto Doppler: quando un'ambulanza ci viene incontro, le sue sirene vengono udite...**
    - [ ] Ad una frequenza più alta
    - [ ] Ad una frequenza più bassa

13. **Il bang supersonico è...**
...
---
# Autovalutazione 5 – Acustica 5

1. **Uno spettro di un tono puro è...**
   - [ ] Discreto
   - [ ] Continuo
   - [ ] Limitato
   - [ ] Illimitato
...
2. **Uno spettro di un tono complesso periodico è...**
   - [ ] Discreto
   - [ ] Continuo
   - [ ] Limitato
   - [ ] Illimitato
...
3. **Uno spettro di un tono complesso non periodico è...**
   - [ ] Discreto
   - [ ] Continuo
   - [ ] Limitato
   - [ ] Illimitato
...
4. **Nell'analisi armonica, la fase delle armoniche può generare spettri diversi.**
   - [ ] Vero
   - [ ] Falso

5. **Il teorema di Fourier recita che "Qualunque funzione periodica di periodo T (o frequenza fondamentale f=1/T) può essere rappresentata mediante una somma di onde sinusoidali e/o cosinusoidali di opportuna ampiezza e di frequenza multipla della frequenza fondamentale"**
   - [ ] Vero
   - [ ] Falso

6. **Quali di queste frasi sulle onde quadre sono vere?**
   - [ ] Le onde sono sempre arrotondate, non possono esistere onde quadre
   - [ ] Ha la stessa frequenza dell'armonica fondamentale
   - [ ] È composta da un numero di armoniche (pari e dispari) tendente a infinito
   - [ ] È composta dalle sole armoniche pari, tendenti a infinito
   - [ ] È composta dalle sole armoniche dispari, tendenti a infinito
   - [ ] È un'onda simmetrica

7. **Quali fra queste definizioni su Serie e Trasformata di Fourier sono vere?**
...
8. **Nella pratica, quale trasformata si preferisce utilizzare?**
   - [ ] La Trasformata di Fourier (FT)
   - [ ] La Trasformata Veloce di Fourier (FFT)
   - [ ] La Trasformata Discreta di Fourier o del Coseno (DCT)

9. **L'operazione inversa dell'analisi armonica si chiama...**
    - [ ] Analisi inversa
    - [ ] Antianalisi
    - [ ] Sintesi
    - [ ] Composizione

10. **Sonogrammi e spettrogrammi permettono di...**
...
---
# Autovalutazione 6 – Acustica 6

1. **Quali fra queste sono successioni di intervalli (modi) validi per una scala diatonica?**
   - [ ] sT - T - T - sT - T - T - T
   - [ ] sT - T - T - T - sT - T - T
   - [ ] T - sT - T - sT - T - T - T
   - [ ] T - T - T - sT - T - T - sT
...
2. **Fissata a 440Hz la frequenza del La4 (cioè il La della 4^ ottava, con ottave che iniziano e terminano con Do), calcolare quanto valgono, rispettivamente: La2, La3, La5, La7**
...
3. **Fissata a 440Hz la frequenza del La4 (cioè il La della 4^ ottava, con ottave che iniziano e terminano con Do), calcolare quanto vale il Re#5**
   - [ ] 800Hz
   - [ ] 880Hz
   - [ ] 587.3Hz
   - [ ] 622.3Hz
...
4. **Fissata a 440Hz la frequenza del La4 (cioè il La della 4^ ottava, con ottave che iniziano e terminano con Do), calcolare quanto vale il Mib4 (Mi bemolle della 4^ ottava)**
   - [ ] 400Hz
   - [ ] 410Hz
   - [ ] circa 330Hz
   - [ ] circa 310Hz
...
5. **Gli inviluppi sonori hanno tutti 4 transitori nell'ordine ADSR, cioè Attack, Decay, Sustain, Release**
   - [ ] Vero
   - [ ] Falso

6. **Quale di questi strumenti musicali ha un inviluppo con 2 picchi caratteristici in fase di Attack?**
   - [ ] Flauto
   - [ ] Tromba
   - [ ] Pianoforte
   - [ ] Violino
...
7. **Quale di questi strumenti musicali è caratterizzato da un transitore Attack seguito immediatamente da un transitore Release?**
   - [ ] Flauto
   - [ ] Tromba
   - [ ] Pianoforte
   - [ ] Violino
...
8. **Il timbro di un suono è una proprietà caratterizzata da...**
   - [ ] Ampiezza del suono
   - [ ] Frequenza del suono
   - [ ] Fase del suono
   - [ ] Spettro delle frequenze

9. **Nello spettro delle frequenze, la frequenza che contribuisce maggiormente (quella con l'ampiezza maggiore) caratterizza...**
...
10. **Nello spettro delle frequenze, il contributo e il numero delle varie frequenze caratterizza...**
    - [ ] Il timbro dello strumento
    - [ ] Il volume del suono
    - [ ] La nota suonata
    - [ ] L'altezza del suono
...
11. **È possibile che due strumenti musicali che suonino la stessa nota abbiano spettri delle frequenze diverse**
    - [ ] Vero
    - [ ] Falso

12. **Quali fra questi rumori sono caratterizzati da valori d'ampiezza che seguono una legge di probabilità uniforme?**
    - [ ] Rumore rosa
    - [ ] Rumore marrone
    - [ ] Rumore bianco
    - [ ] Rumore grigio
...
13. **Quali fra questi rumori sono caratterizzati da valori d'ampiezza che decrescono per ogni ottava?**
    - [ ] Rumore rosa
    - [ ] Rumore marrone
    - [ ] Rumore bianco
    - [ ] Rumore grigio
...
14. **Quali fra questi rumori sono caratterizzati da valori d'ampiezza che crescono per ogni ottava?**
    - [ ] Rumore rosa
    - [ ] Rumore marrone
    - [ ] Rumore bianco
    - [ ] Rumore grigio
...
15. **Quali fra questi rumori ricordano il suono della pioggia o di una cascata?**
    - [ ] Rumore rosa
    - [ ] Rumore marrone
    - [ ] Rumore bianco
    - [ ] Rumore grigio
...
16. **Quali fra questi rumori ricorda maggiormente il fischio di una pentola a vapore?**
    - [ ] Rumore rosa
    - [ ] Rumore marrone
    - [ ] Rumore bianco
    - [ ] Rumore grigio
...
17. **Quali fra questi rumori segue un andamento simile a quello delle curve isofoniche?**
    - [ ] Rumore rosa
    - [ ] Rumore marrone
    - [ ] Rumore bianco
    - [ ] Rumore grigio
...
---
# Autovalutazione 7 – Psicoacustica 1

1. **Quali sono i funzionamenti principali legati all'udito individuati dagli psicofisici?**
...
2. **Quali fra questi sono i compiti del sistema uditivo?**
...
3. **Per quanto riguarda l'udito, dal punto di vista scientifico degli psicofisici, quale di questi funzionamenti non è ancora esattamente chiaro?**
   - [ ] Funzionamento creativo
   - [ ] Funzionamento cognitivo
   - [ ] Funzionamento adattivo
   - [ ] Funzionamento fisiologico

4. **Quali fra questi elementi dell'orecchio segna il confine fra orecchio esterno e orecchio medio?**
...
5. **Quali fra questi elementi dell'orecchio rappresenta un sistema di protezione dai suoni ad altissimo volume?**
   - [ ] Padiglione auricolare
   - [ ] Condotto uditivo
   - [ ] Timpano
   - [ ] Martello
...
6. **Quali fra questi elementi dell'orecchio serve per bilanciare la pressione interna con quella esterna?**
   - [ ] Padiglione auricolare
   - [ ] Condotto uditivo
   - [ ] Timpano
   - [ ] Martello
...
7. **Quali fra questi elementi dell'orecchio serve per restare in equilibrio?**
   - [ ] Padiglione auricolare
   - [ ] Condotto uditivo
   - [ ] Timpano
   - [ ] Martello
...
8. **Quali fra questi elementi dell'orecchio serve a trasformare i segnali sonori in segnali nervosi?**
   - [ ] Padiglione auricolare
   - [ ] Condotto uditivo
   - [ ] Timpano
   - [ ] Martello
...
9. **Martello, Incudine e Staffa sono...**
...
10. **Secondo il dlgs 81/2008, al di sotto degli 80dB...**
    - [ ] Non c'è obbligo di utilizzare i DPI
...
11. **Secondo il dlgs 81/2008, fra 80 e 85 dB...**
    - [ ] Non c'è obbligo di utilizzare i DPI
    - [ ] I DPI sono consigliati
    - [ ] I DPI sono obbligatori
    - [ ] L'informazione e la formazione sono consigliate ma non obbligatorie
...
12. **Secondo il dlgs 81/2008, oltre 85 dB...**
    - [ ] Non c'è obbligo di utilizzare i DPI
    - [ ] I DPI sono consigliati
    - [ ] I DPI sono obbligatori
    - [ ] L'informazione e la formazione sono consigliate ma non obbligatorie
...
13. **Secondo il dlgs 81/2008, il limite massimo di 87dB si riferisce a...**
...
14. **Il Quizzone finale: quali fra queste affermazioni sulla coclea sono vere?**
    - [ ] La staffa è in contatto con la finestra ovale
    - [ ] La staffa è in contatto con la finestra rotonda
    - [ ] La vibrazione entra nella coclea dal canale superiore (rampa vestibolare)
...
---
# Autovalutazione 8 – Psicoacustica 1

1. **La Frequenza influisce su...**
   - [ ] Volume alto o basso
   - [ ] Suono acuto o grave
   - [ ] Timbro o armonia del suono

2. **L'Ampiezza influisce su...**
   - [ ] Suono acuto o grave
   - [ ] Timbro o armonia del suono
   - [ ] Volume alto o basso

3. **Lo Spettro influisce su...**
   - [ ] Timbro o armonia del suono
   - [ ] Volume alto o basso
   - [ ] Suono acuto o grave

4. **Nella definizione di Sound Intensity Level (SIL) il valore di intensità I_0 ("i con zero") è riferito ad un'onda di frequenza...**
   - [ ] 0 Hz
   - [ ] 50 Hz
   - [ ] 100 Hz
   - [ ] 250 Hz
...
5. **Una frequenza pari a 1kHz con 50dB SIL ha un volume di...**
   - [ ] 0 phon
   - [ ] 10 phon
   - [ ] 20 phon
   - [ ] 30 phon
...
6. **Una frequenza pari a 1kHz con 30dB SIL ha un volume di...**
   - [ ] 0 phon
   - [ ] 10 phon
   - [ ] 20 phon
   - [ ] 30 phon
...
![[Pasted image 20241130171448.png]]

7. **Rispetto alla Figura 1, la zona tratteggiata a sinistra indica...**
...
8. **Rispetto alla Figura 1, i punti P, Q, e R indicano...**
   - [ ] 3 suoni a 50dB
   - [ ] 3 suoni percepiti con lo stesso volume
   - [ ] 3 suoni con la stessa frequenza
   - [ ] Lo stesso suono

9. **Rispetto alla Figura 1, qual è il range di frequenze in cui l'orecchio umano risulta essere più sensibile?**
...
10. **Rispetto alla Figura 1, sono ammessi valori di dB negativi?**
    - [ ] Vero
    - [ ] Falso

11. **Rispetto alla Figura 1, sono ammessi valori di phon negativi?**
    - [ ] Vero
    - [ ] Falso

12. **Per "frequenza fantasma" si intende...**
...
13. **Indicare le affermazioni corrette:**
...
# Autovalutazione 9 – Psicoacustica 3

1. **Il principale determinante fisico del timbro è...**
   - [ ] La frequenza fondamentale
   - [ ] La frequenza di Nyquist
   - [ ] L'armonica fondamentale
   - [ ] Il contenuto armonico

2. **Indicare le affermazioni vere:**
...
![[Pasted image 20241130171609.png]]

3. **Facendo riferimento alla Figura 1, indicare l'affermazione vera:**
...
4. **La larghezza di banda critica di un segnale da 350Hz è...**
   - [ ] Più di 5000Hz
   - [ ] 5000Hz
   - [ ] 2500Hz
   - [ ] 1000Hz
...
5. **La larghezza di banda critica di un segnale da 1250Hz è...**
   - [ ] Più di 5000Hz
   - [ ] 5000Hz
   - [ ] 2500Hz
   - [ ] 1000Hz
...
6. **La larghezza di banda critica di un segnale da 15kHz è...**
   - [ ] Più di 5000Hz
   - [ ] 5000Hz
   - [ ] 2500Hz
   - [ ] 1000Hz
...
7. **Quante sono le bande critiche definite nella Scala di Bark mostrata a lezione?**
   - [ ] 14
   - [ ] 21
   - [ ] 22
   - [ ] 23
...
![[Pasted image 20241130171618.png]]

8. **Facendo riferimento alla Figura 2, quali sono le bande più piccole?**
   - [ ] Quelle a sinistra del grafico
   - [ ] Quelle a destra nel grafico
   - [ ] Bel tentativo! Tutte le bande di Bark hanno la stessa grandezza!

$\text{Figura 3. Mascheramento non tonale con rumore a banda larga}$
![[Pasted image 20241130171631.png]]

9. **Con riferimento alla Figura 3 - Mascheramento non tonale con rumore a banda larga, quali di queste frasi sul mascheramento non tonale con rumore a banda larga sono vere:**
...
10. **Aiutandoti con la Figura 3, quali di queste frasi sul mascheramento non tonale con rumore a banda larga sono vere:**
...
11. **Aiutandoti con la Figura 3, in generale, il mascheramento non tonale con rumore a banda larga...**
...
![[Pasted image 20241130171702.png]]

12. **Con riferimento alla Figura 4 - Mascheramento non tonale con rumore a banda stretta, quali di queste frasi sul mascheramento non tonale con rumore a banda stretta sono vere:**
...
13. **Aiutandoti con la Figura 4, in generale, il mascheramento non tonale con rumore a banda stretta...**
    - [ ] Maschera meglio le basse frequenze
    - [ ] Maschera meglio le frequenze medie
    - [ ] Maschera meglio le alte frequenze
    - [ ] Maschera in maniera simile tutte le frequenze
...
![[Pasted image 20241130171732.png]]

14. **Con riferimento alla Figura 5 - Mascheramento tonale con tono semplice, quali di queste frasi sul mascheramento tonale con tono semplice sono vere:**
...
15. **Aiutandoti con la Figura 5, in generale, il mascheramento tonale con tono semplice...**
...
16. **Confrontando mascheramento non tonale con rumore a banda stretta e mascheramento tonale con tono semplice, quale fra queste frasi è vera?**
...
17. **Nella "Tuning Curve" del mascheramento tonale con tono semplice...**
...
---
# Autovalutazione 10 – Digitalizzazione 1

1. **Individuare le affermazioni vere fra quelle in elenco:**
   - [ ] È sempre meglio effettuare la fase di processing sul dato digitalizzato, perché non c'è rischio di danneggiamento irreversibile
...
2. **Quali sono i 3 componenti principali di un dispositivo di digitalizzazione?**
   - [ ] Equalizzatori
   - [ ] Decoder
   - [ ] Distorsori
...
3. **Quali fra questi sono dispositivi che hanno a che fare con la digitalizzazione?**
   - [ ] DC
   - [ ] AC
   - [ ] AC/DC
   - [ ] DAC
...
4. **La frequenza di Nyquist si troverà verosimilmente...**
   - [ ] Fra le frequenze più basse
   - [ ] Vicino la frequenza fondamentale
   - [ ] Vicino la frequenza fantasma
   - [ ] Fra le frequenze più alte

5. **Il teorema del campionamento di Nyquist-Shannon afferma che...**
...
6. **Indicare le affermazioni vere riguardo al campionamento critico:**
...
7. **Shannon è ed è stato...**
   ...
   - [ ] Tutte le precedenti (lol)

8. **Campionare con il giusto tasso di campionamento non basta. Bisogna anche applicare un filtro...**
   - [ ] Filtro Passa-Basso
   - [ ] Filtro Passa-Alto

9. **L'aliasing è dovuto a...**
   - [ ] Sottocampionamento
   - [ ] Frequenze campionate sovrapposte alle frequenze originali del segnale
   - [ ] Dispositivi ADC scadenti
   - [ ] Campionamento Critico

10. **Fra quelle indicate, quale potrebbe essere una buona frequenza di campionamento per un suono?**
    - [ ] 100Hz
    - [ ] 500Hz
    - [ ] 1000Hz
    - [ ] 5000Hz
...
---
# Autovalutazione 11 – Digitalizzazione 2

1. **L'errore di quantizzazione è dovuto a...**
...
2. **La quantizzazione logaritmica è l'unico tipo di quantizzazione non uniforme**
   - [ ] Vero
   - [ ] Falso

3. **La gamma dinamica è...**
...
4. **L'errore max nella quantizzazione uniforme è pari a...**
   - [ ] La gamma dinamica
...
6. **Nella formula per calcolare il SQNR, la N indica...**
   - [ ] Il Noise
   - [ ] Il numero di bit nella codifica
   - [ ] Il numero di quanti
   - [ ] Il numero di campioni

7. **Dato N=16, quanto vale il SQNR?**
...
8. **Dato un SQNR pari a 72, quanto vale N?**
   - [ ] Non abbiamo sufficienti dati per calcolarlo
   - [ ] 12
   - [ ] 13
   - [ ] 14
...
9. **SQNR dovrebbe avere almeno valori...**
   - [ ] > 20dB
   - [ ] > 40dB
   - [ ] > 60dB
   - [ ] > 80dB
...
10. **Valori sufficientemente buoni di SQNR si hanno per...**
    - [ ] > 20dB
    - [ ] > 40dB
    - [ ] > 60dB
    - [ ] > 80dB
...
11. **I dispositivi digitali hanno valori di SQNR...**
    - [ ] > 20dB
    - [ ] > 40dB
    - [ ] > 60dB
    - [ ] > 80dB
...
12. **Dato un tasso di campionamento pari a 44.1kHz e una PCM a 16bit, quanti byte servono per memorizzare un audio mono di 10 secondi?**
    - [ ] Circa 880KB
    - [ ] Circa 7MB
    - [ ] Circa 7KB
    - [ ] Circa 5MB
...
13. **I bit di parità permettono di...**
...
---
# Autovalutazione 12 – Digitalizzazione 3

1. **Assumendo una PCM a 8 bit, quali fra queste sono possibili rappresentazioni per l'ampiezza?**
   - [ ] Da -128 a 127
   - [ ] Da -32.768 a 32.767
   - [ ] Da -8 a 7
   - [ ] Da -1 a 1
...
2. **Cosa accade alla durata di una traccia audio se aumento la frequenza di campionamento?**
   - [ ] Non abbiamo sufficienti elementi per rispondere
   - [ ] La sua durata aumenta
   - [ ] La sua durata diminuisce

3. **Cosa accade se convertiamo un segnale stereo in un segnale mono?**
   - [ ] Perdiamo campioni
...
6. **Gli equalizzatori (EQ) sono strumenti utili per...**
...
8. **L'intensità di attenuazione/guadagno (in dB) è un parametro importante per un filtro HPF**
   - [ ] Vero
   - [ ] Falso

9. **I filtri Low-Shelving e High-Shelving sono come i filtri LPF e HPF, ma su valori positivi anziché negativi**
   - [ ] Vero
   - [ ] Falso

10. **Nei filtri di peaking, quali delle seguenti affermazioni sulla Q sono vere?**
...
---
# Autovalutazione 13 – Digitalizzazione 4 (Può essere che NON C'È PROPRIO!!!)

1. **Gli equalizzatori grafici sono un'implementazione su interfaccia di filtri...**
   - [ ] HPF
   - [ ] LPF
   - [ ] Shelving
   - [ ] A campana
...
4. **A cosa è dovuto l'effetto "Clipping"?**
...
5. **Il Fade-In e il Fade-Out sono due effetti che vanno inseriti, rispettivamente, all'inizio e alla fine di una traccia audio**
   - [ ] Vero
   - [ ] Falso

6. **Gli operatori sul range dinamico modificano...**
   - [ ] Fase
   - [ ] Lunghezza d'onda
   - [ ] Periodo
   - [ ] Intensità
...
7. **Quali di queste frasi sull'operatore Compressore sono vere:**
...
![[Pasted image 20241130172048.png]]

8. **Rispetto al Grafico degli Operatori Dinamici, in quale area si colloca l'operatore Espansore?**
   - [ ] A
   - [ ] B
   - [ ] C
   - [ ] D
...
9. **Rispetto al Grafico degli Operatori Dinamici, in quale area si colloca l'operatore che applica effetti simili al Clipping?**
   - [ ] A
   - [ ] B
   - [ ] C
   - [ ] D
...
10. **Rispetto al Grafico degli Operatori Dinamici, in quale area si colloca l'operatore Compressore?**
    - [ ] A
    - [ ] B
    - [ ] C
    - [ ] D
...
11. **Rispetto al Grafico degli Operatori Dinamici, in quale area si colloca l'operatore che lascia pressoché invariato l'input?**
    - [ ] A
    - [ ] B
    - [ ] C
    - [ ] D
...
12. **Rispetto al Grafico degli Operatori Dinamici, in quale area si colloca l'operatore che attenua il rumore?**
    - [ ] A
    - [ ] B
    - [ ] C
    - [ ] D
...
13. **Rispetto al Grafico degli Operatori Dinamici, in quale area si colloca l'operatore che può essere usato per restaurare una traccia audio scarsamente udibile?**
    - [ ] A
    - [ ] B
    - [ ] C
    - [ ] D
...
14. **Rispetto al Grafico degli Operatori Dinamici, in quale area si colloca un operatore che può essere usato per aumentare il volume di una pubblicità?**
    - [ ] A
    - [ ] B
    - [ ] C
    - [ ] D
...
15. **È possibile applicare un solo operatore alla volta per processare una traccia audio**
    - [ ] Vero
    - [ ] Falso

---
# Autovalutazione 14 – Compressione 1

1. **La compressione serve a...**
...
2. **La compressione del silenzio...**
   - [ ] È una tecnica lossless
   - [ ] È una tecnica lossy
   ...
   - [ ] È facile da applicare, perché è facile individuare cosa sia silenzio

3. **La soglia Tq (Threshold to quiet) indica:**
...
4. **Qual è il bit-rate di una traccia audio di un segnale mono acquisito con tasso di campionamento pari a 44,1kHz e PCM lineare a 24bit?**
   - [ ] 705.6kbps
   - [ ] 705.6Mbps
   - [ ] 1058kbps
   - [ ] 1058Mbps
...
6. **Nella codifica μ-Law, quanto vale la μ?**
   - [ ] (2^2)-1
   - [ ] (2^6)-1
   - [ ] (2^8)-1
   - [ ] (2^13)-1
...
7. **Nella codifica μ-Law, la x...**
   - [ ] È normalizzata fra 0 e 1
   - [ ] È normalizzata fra -1 e 1
   - [ ] È normalizzata fra 0 e -60dB
   - [ ] Non è normalizzata
   - [ ] È codificata con una codifica con segno
   - [ ] È codificata con una codifica senza segno
   - [ ] Rappresenta un range continuo di valori
   - [ ] Rappresenta un range discreto di valori

8. **La DEcodifica μ-Law si basa principalmente su...**
   - [ ] Un logaritmo
   - [ ] Una potenza
   - [ ] Una derivata
   - [ ] Un integrale
...
9. **Nelle codifiche μ-Law e A-Law avranno maggior precisione i valori di intensità (rispetto a un range da -1 a 1)...**
   - [ ] Bassi (vicino -1)
   - [ ] Medi (vicino 0)
   - [ ] Alti (vicino 1)

10. **Se disegnassimo la curva che mostra la Ri-quantizzazione da Quantizzazione uniforme a non uniforme nelle codifiche μ-Law e A-Law, la curva avrebbe una forma...**
    - [ ] Lineare
    - [ ] Esponenziale
    - [ ] Logaritmica
    - [ ] Sinusoidale
...
11. **Quali fra queste affermazioni sulle codifiche μ-Law e A-Law è vera, confrontandole ad una quantizzazione uniforme?**
...
12. **La PCM si può migliorare con...**
...
---
# Autovalutazione 15 – Compressione 2

1. **La definizione migliore di "Codifica trasparente" è:**
...
2. **Chi fra questi personaggi è noto come "il padre delle codifiche di compressione di tipo percettivo"?**
   - [ ] Shannon
   - [ ] Bell
   - [ ] Nyquist
   - [ ] Johnston
...
3. **Il limite per ottenere la codifica trasparente calcolato da J.D. Johnston è pari a...**
   - [ ] La frequenza di Nyquist
   - [ ] La frequenza fondamentale
...
4. **Dato un tasso di campionamento pari a 22kHz e un bitrate (compresso) di 128kbps, dire se la codifica sia o meno trasparente.**
   - [ ] Vero
   - [ ] Falso

5. **Qual è lo scopo principale della tecnica Compansion?**
...
6. **Quali sono le 4 tecniche principali su cui si basa la compressione di tipo percettivo?**
...
7. **Come si può risolvere il problema dei pre-echi?**
...
8. **Quale trasformata è più efficiente?**
   - [ ] FT
   - [ ] FFT
   - [ ] SFT
   - [ ] DFT
...
9. **Quali affermazioni su QMF sono vere?**
   - [ ] È un banco di filtri che divide il range di frequenze in alto e basso
   - [ ] È possibile applicare solo un banco di filtri QMF per volta
   - [ ] È possibile applicare più di un banco di filtri QMF per volta
   - [ ] Le due bande di QMF devono necessariamente avere sempre e in ogni caso la stessa grandezza

10. **Indicare le qualità della codifica di Huffman**
...
---
# Autovalutazione 16 – Formati 1

1. **Lo standard MPEG è relativo a...**
   - [ ] Video
   - [ ] Audio
   - [ ] Altro contenuto multimediale (ad esempio il VR)
   - [ ] Tutte le precedenti

2. **MPEG-4 è uno standard per...**
   - [ ] Codifica
   - [ ] Interfaccia di scambio
   - [ ] Archiviazione

3. **MPEG-7 è uno standard per...**
   - [ ] Codifica
   - [ ] Interfaccia di scambio
   - [ ] Archiviazione

4. **MPEG-21 è uno standard per...**
   - [ ] Interfaccia di scambio
   - [ ] Codifica
   - [ ] Archiviazione

5. **Gli standard MPEG garantiscono la retrocompatibilità. Questo significa che è possibile decodificare con MPEG-2 qualcosa codificato con MPEG-4**
   - [ ] Vero
   - [ ] Falso

6. **Su quali parti degli standard MPEG potrebbe essere necessario pagare delle royalties?**
   - [ ] Obbligatorie
   - [ ] Libere

7. **MP3 è un formato relativo principalmente a...**
   - [ ] MPEG-1
   - [ ] MPEG-2
   - [ ] MPEG-3
   - [ ] MPEG-4

8. **Quali di queste affermazioni sul layer I di MPEG-1 sono vere:**
   - [ ] Conta 12 bande
   - [ ] Conta 26 bande
   - [ ] Conta 32 bande
...
9. **Il Layer I di MPEG-1 applica una Codifica per Bande**
   - [ ] Vero
   - [ ] Falso

10. **Quali sono i miglioramenti di MPEG-1 Layer II rispetto a Layer I?**
...
11. **Quali sono i miglioramenti di MPEG-1 Layer III rispetto a Layer II?**
    - [ ] DFT al posto di FFT
    - [ ] DCT al posto di FFT
...
12. **Quali fra questi formati audio avanzati è il migliore per applicazioni di archiviazione?**
    - [ ] AAC
    - [ ] Dolby AC-3
    - [ ] WMA
    - [ ] FLAC

13. **Quali fra questi formati audio avanzati ha prestazioni migliori sulla musica e peggiori sulla voce, rispetto a MPEG?**
    - [ ] AAC
    - [ ] Dolby AC-3
    - [ ] WMA
    - [ ] FLAC
...
---
# Autovalutazione 17 – Formati 2

1. **Qual è il significato dell'acronimo MIDI?**
...
3. **Quale fra questi è lo scopo principale per cui è nato il MIDI?**
...
4. **Quanti Canali sono definibili nel MIDI?**
   - [ ] 8
   - [ ] 16
   - [ ] 24
   - [ ] 32
...
5. **Quante Tracce sono definibili nel MIDI?**
   - [ ] 8
   - [ ] 16
   - [ ] 24
   - [ ] 32
...
6. **Quante Patch sono definibili nel MIDI?**
   - [ ] 8
   - [ ] 16
   - [ ] 24
   - [ ] 32
...
7. **Quanti Banchi sono definibili nel MIDI?**
   - [ ] 8
   - [ ] 16
   - [ ] 24
   - [ ] 32
...
8. **Quale fra i seguenti indica il livello di astrazione per rappresentare le varie voci di un brano?**
   - [ ] Sequencer
   - [ ] Canali
   - [ ] Tracce
   - [ ] Patch
...
9. **Quale fra i seguenti indica il livello di astrazione per implementare il concetto di strumento?**
   - [ ] Sequencer
   - [ ] Canali
   - [ ] Tracce
   - [ ] Patch
...
10. **Quale fra i seguenti indica il livello di astrazione per implementare il concetto di partiture e mixing?**
    - [ ] Sequencer
    - [ ] Canali
    - [ ] Tracce
    - [ ] Patch
...
11. **Quale fra i seguenti indica il livello di astrazione per implementare il concetto di timbro?**
    - [ ] Sequencer
    - [ ] Canali
    - [ ] Tracce
    - [ ] Patch
...
12. **La relazione fra Canali-e-Tracce è...**
    - [ ] 1-1
    - [ ] 1-N
    - [ ] N-1
    - [ ] N-N

13. **La relazione fra Canali-e-Patch è...**
    - [ ] 1-1
    - [ ] 1-N
    - [ ] N-1
    - [ ] N-N

14. **Calcolare quanto dura 1 tick essendo BPM=240 e PPQ=48**
    - [ ] 5 secondi
    - [ ] 0.5 secondi
    - [ ] 0.05 secondi
    - [ ] 0.005 secondi
...
15. **Se i primi 4 bit, esclusi quelli di sincronizzazione, di un messaggio MIDI sono uguali a 1001, allora si avrà un...**
    - [ ] System Message
...
16. **Se i primi 4 bit, esclusi quelli di sincronizzazione, di un messaggio MIDI sono uguali a 1100, allora si avrà un...**
    - [ ] System Message
    - [ ] Channel Message - Note On
...
17. **Se i primi 4 bit, esclusi quelli di sincronizzazione, di un messaggio MIDI sono uguali a 1111, allora si avrà un...**
    - [ ] System Message
    - [ ] Channel Message - Note On
    - [ ] Channel Message - Pitch Bend Change
    - [ ] Channel Message - Note Off
...
18. **Se i primi 4 bit, esclusi quelli di sincronizzazione, di un messaggio MIDI sono uguali a 0111, allora si avrà un...**
    - [ ] System Message
    - [ ] Channel Message - Note On
    - [ ] Channel Message - Pitch Bend Change
    - [ ] Channel Message - Channel Pressure
